...
const faqs: FAQItem[] = [
  {
    ...
    answer: 'Sí, absolutamente. Tecnera permite importar tu base de datos actual desde archivos CSV o Excel. Nuestro sistema mapea automáticamente los campos y valida la información para garantizar una migración sin errores. El proceso toma solo minutos y conservas todo tu historial.'
  },
  {
    question: '¿Cuanto tiempo lleva tener algo funcionando?',
    answer: 'Depende del alcance, pero en muchos casos podes tener una primera version funcional en pocas semanas. Trabajamos con entregas progresivas para que veas avances desde el inicio.',
  },
  {
    question: '¿Que pasa despues de la entrega?',
    answer: 'Te seguimos acompañando. Ofrecemos soporte tecnico, mantenimiento y mejoras continuas para que tu solucion evolucione junto con tu organizacion.',
  },
  {
    question: '¿Es solo para organizaciones grandes?',
    answer: 'No. Trabajamos con mutuales, clubes, colegios profesionales y organizaciones de distintos tamaños. Adaptamos cada solucion a tu realidad y presupuesto.',
  },
  {
    question: '¿Qué pasa si ya tengo un sistema?',
    answer: 'No hay problema. Podemos trabajar en paralelo durante un período de transición para que migres de manera gradual. También ofrecemos capacitación para tu equipo y asistencia técnica durante todo el proceso. Muchas organizaciones comienzan con una prueba piloto antes de migrar completamente.'
  },
];
      ...
      <div className="mx-auto max-w-3xl px-4 tablet:px-6 laptop:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-[#EAEAEA] to-white rounded-xl shadow-lg overflow-hidden border-l-4 border-[#00A478] hover:shadow-xl transition-shadow duration-300"
            >
              <button
